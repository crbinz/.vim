...
if &background == "light"
	...
	hi UT1 guifg=red	ctermfg=cyan
	hi UT2 guifg=red	ctermfg=cyan
	hi UT3 guifg=red	ctermfg=cyan
	hi UT4 guifg=red	ctermfg=cyan
	hi UT5 guifg=red	ctermfg=cyan
	hi UT6 guifg=red	ctermfg=cyan
	hi UT7 guifg=red	ctermfg=cyan
	hi UT8 guifg=red	ctermfg=cyan
	hi UT9 guifg=red	ctermfg=cyan
	...
	hi spellErr gui=underline guifg=red cterm=underline ctermfg=red
	hi BadWord gui=underline guifg=red cterm=underline ctermfg=red
" Dark background {{{2
else 
	hi OL1 guifg=white	ctermfg=white
	hi OL2 guifg=khaki 	ctermfg=gray
	hi OL3 guifg=skyblue 	ctermfg=lightblue
	hi OL4 guifg=lightgreen ctermfg=lightgreen
	...
	" colors for folded sections
	hi Folded guifg=gold guibg=bg	ctermfg=cyan ctermbg=black
	hi FoldColumn guifg=gold guibg=bg	ctermfg=cyan ctermbg=black
